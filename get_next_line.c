...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/21 19:45:09 by ziharuty          #+#    #+#             */
/*   Updated: 2023/03/04 14:55:35 by ziharuty         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (fd < 0 || BUFFER_SIZE <= 0)
		return (0);
	leftstr = ft_read_str(fd, leftstr);
	if (!leftstr)
		return (NULL);
	line = ft_get_line(leftstr);
	leftstr = ft_get_new_line(leftstr);
	return (line);
}
